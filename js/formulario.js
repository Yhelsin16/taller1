...
const validarFormulario = (e) => {
	switch (e.target.name) {
		...
		case "apellido":
			...
			break;
		case "fechaNa":
			validarCampo(expresiones.fechaNa, e.target, 'fechaNa')
			break;
		case "password":
...
formulario.addEventListener('submit', (e) => {
    ...
    if (tipoDoc.selected  && campos.numDoc && campos.nombre && campos.apellido && campos.fechaNa && campos.password && campos.correo && terminos.checked) {
